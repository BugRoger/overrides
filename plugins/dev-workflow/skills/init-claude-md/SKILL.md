---
description: Initialize a CLAUDE.md file with a standard template
---

# Init CLAUDE.md

Create a `CLAUDE.md` file in the current repository root with the following template. If a CLAUDE.md already exists, ask the user before overwriting.
...
2. Fill in the Prime Directives with project-specific rules
3. Add any project-specific sections as needed following the META guidelines
